...
| **chrony** | 4.4 | chrony is an implementation of the Network Time Protocol (NTP) | https://chrony-project.org/ |
...
| **clang** | 17.0.5 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **gh** | 2.39.1 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **gitea** | 1.21.0 | Git with a cup of tea, painless self-hosted git service | https://gitea.io |
...
| **libcompiler-rt** | 17.0.5 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libdav1d** | 1.3.0 | AV1 cross-platform decoder focused on speed and correctness | https://code.videolan.org/videolan/dav1d/ |
...
| **libgrpc** | 1.60.0-pre1-0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libllvm** | 17.0.5 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 17.0.5 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libmpfr** | 4.2.1 | C library for multiple-precision floating-point computations with correct rounding | https://www.mpfr.org/ |
| **libmpfr-static** | 4.2.1 | Static libraries for libmpfr | https://www.mpfr.org/ |
...
| **libpolly** | 17.0.5 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **libxapian** | 1.4.24 | Xapian search engine library | https://xapian.org |
...
| **lld** | 17.0.5 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 17.0.5 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 17.0.5 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 17.0.5 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **mlir** | 17.0.5 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **mpd** | 0.23.14-1 | Music player daemon | https://www.musicpd.org |
...
| **nodejs** | 20.2.0-1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
| **nodejs-lts** | 18.16.1-1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **vtm** | 0.9.20 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
