...
if ($env:SKIP_BUILD -eq "NO") {
   #age: A simple, modern and secure encryption tool
    $env:BIN = "age" # Name of final binary/pkg/cli, sometimes differs from $REPO
    $env:SOURCE_URL = "https://github.com/FiloSottile/age" # github/gitlab/homepage/etc for $BIN
