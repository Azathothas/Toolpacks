...
if [ "$SKIP_BUILD" == "NO" ]; then
   #busybox : GNU File, Shell, and Text utilities
     ...
     #-------------------------------------------------------#    
      ...
      #List
       curl -qfsSL "https://pub.ajam.dev/repos/Azathothas/Toolpacks/.github/scripts/arm64_v8a_Android/bins/busybox.yaml" -o "$TMP_METADIR/temp.yaml"
