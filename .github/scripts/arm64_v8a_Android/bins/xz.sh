    ...
    #xz : A general-purpose data compression software, successor of LZMA
     ...
     #-------------------------------------------------------#    
      ...
      #List
       ...
       rclone lsjson --fast-list "r2:/bin/arm64_v8a_Android/Baseutils/xz/"  --exclude="BLAKE3SUM" --exclude="*.7z" --exclude="*.json" --exclude="*.log" --exclude="*.md" --exclude="SHA256SUM" --exclude="*.txt" | \
