   ...
   #coreutils : GNU File, Shell, and Text utilities
     ...
     #-------------------------------------------------------#    
      ##Build (ndk-pkg)
       ...
       docker exec -it "ndk-pkg" ndk-pkg install "${TOOLPACKS_ANDROID_BUILD_STATIC}/coreutils" --profile="release" -j "$(($(nproc)+1))" --static
      ...
      #List
       BUILD_URL="https://pub.ajam.dev/repos/Azathothas/Toolpacks/.github/scripts/arm64_v8a_Android/bins/coreutils.yaml" && export BUILD_URL="$BUILD_URL"
