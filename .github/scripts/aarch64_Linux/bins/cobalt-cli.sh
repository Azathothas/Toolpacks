...
if [ "$SKIP_BUILD" == "NO" ]; then
    #cobalt : Command-line interface wrapper for https://cobalt.tools
     export BIN="cobalt" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/lostdusty/cobalt" #github/gitlab/homepage/etc for $BIN
      ...
      #Build (alpine-musl)
       ...
       docker run --privileged --net="host" --name "alpine-builder" "azathothas/alpine-builder:latest" \
        ...
        #Setup ENV
         ...
         mkdir -p "/build-bins"
        #Build
         git clone --quiet --filter "blob:none" "https://github.com/lostdusty/cobalt" && cd "./cobalt"
