...
if [ "$SKIP_BUILD" == "NO" ]; then
   #toybox : minimal busybox
     ...
     echo -e "\n\n [+] (Building | Fetching) $BIN :: $SOURCE_URL\n"
      #Fetch
       eval "$EGET_TIMEOUT" eget "https://landley.net/toybox/bin/toybox-aarch64" --to "$BINDIR/toybox"
       eval "$EGET_TIMEOUT" eget "https://landley.net/toybox/bin/toybox-aarch64" --to "$BASEUTILSDIR/toybox"
fi
#-------------------------------------------------------#
