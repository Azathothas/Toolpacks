...
if [ "${SKIP_BUILD}" == "NO" ]; then
    #runimage-run: ELF wrapper for RunImage Run.sh script in the extracted form
     export BIN="runimage-run"
     export SOURCE_URL="https://github.com/VHSgunzo/Run-wrapper"
