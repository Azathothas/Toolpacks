...
if [ "${SKIP_BUILD}" == "NO" ]; then
     ...
     export BIN="dnslookup" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/ameshkov/dnslookup" #github/gitlab/homepage/etc for $BIN
