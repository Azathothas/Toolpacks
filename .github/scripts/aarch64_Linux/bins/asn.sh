...
if [ "$SKIP_BUILD" == "NO" ]; then
     ...
     export BIN="asn" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/nitefood/asn" #github/gitlab/homepage/etc for $BIN
