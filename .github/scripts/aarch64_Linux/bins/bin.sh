...
if [ "$SKIP_BUILD" == "NO" ]; then
     ...
     export BIN="bin" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/marcosnils/bin" #github/gitlab/homepage/etc for $BIN
