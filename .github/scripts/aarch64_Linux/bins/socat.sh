...
if [ "$SKIP_BUILD" == "NO" ]; then
    #socat : successor to netcat
     ...
     export SOURCE_URL="http://www.dest-unreach.org/socat/" #github/gitlab/homepage/etc for $BIN
     echo -e "\n\n [+] (Building | Fetching) $BIN :: $SOURCE_URL\n"
      #Fetch
       eval "$EGET_TIMEOUT" eget "Azathothas/static-toolbox" --tag "socat" --asset "aarch64" --to "$BINDIR/socat"
fi
#-------------------------------------------------------#
