...
if [ "$SKIP_BUILD" == "NO" ]; then
     ...
     export BIN="htmlq" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/mgdm/htmlq" #github/gitlab/homepage/etc for $BIN
