...
if [ "$SKIP_BUILD" == "NO" ]; then
   #wth : What The Heck: The better personal information dashboard for your terminal
     export BIN="wth" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/mrusme/wth" #github/gitlab/homepage/etc for $BIN
