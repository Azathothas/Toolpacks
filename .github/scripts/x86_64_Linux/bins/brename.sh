...
if [ "$SKIP_BUILD" == "NO" ]; then
     ...
     export BIN="brename" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/shenwei356/brename" #github/gitlab/homepage/etc for $BIN
