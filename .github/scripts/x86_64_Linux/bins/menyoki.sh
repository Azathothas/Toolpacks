...
if [ "${SKIP_BUILD}" == "NO" ]; then
    #menyoki : Screen{shot,cast} and perform ImageOps on the command line 🌱 🏞️ 
     export BIN="menyoki" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/orhun/menyoki" #github/gitlab/homepage/etc for $BIN
