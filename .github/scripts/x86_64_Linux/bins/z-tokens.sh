...
if [ "$SKIP_BUILD" == "NO" ]; then
     ...
     export BIN="z-tokens" #Name of final binary/pkg/cli, sometimes differs from $REPO
     ...
     echo -e "\n\n [+] (Building | Fetching) $BIN :: $SOURCE_URL\n"
      #Build  
       ...
       cp "./workspace/target/$RUST_TARGET/release/z-tokens" "$BINDIR/z-tokens"
       cp "./workspace/target/$RUST_TARGET/release/zt-encodings" "$BINDIR/zt-encodings"
