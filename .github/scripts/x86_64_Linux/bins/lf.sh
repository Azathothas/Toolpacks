...
if [ "$SKIP_BUILD" == "NO" ]; then
   #lf : Terminal file manager
     export BIN="lf" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/gokcehan/lf" #github/gitlab/homepage/etc for $BIN
