    ...
    #binutils: Tools for manipulating binaries (linker, assembler, etc.) (wrapper script)
     ...
     #-------------------------------------------------------#
      ...
      ##Meta
       ...
       rclone lsjson --fast-list "r2:/bin/x86_64_Linux/Baseutils/binutils/"  --exclude="BLAKE3SUM" --exclude="*.7z" --exclude="*.json" --exclude="*.log" --exclude="*.md" --exclude="SHA256SUM" --exclude="*.txt" | \
