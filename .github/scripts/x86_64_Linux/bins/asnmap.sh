...
if [ "$SKIP_BUILD" == "NO" ]; then
     ...
     export BIN="asnmap" #Name of final binary/pkg/cli, sometimes differs from $REPO
     ...
     echo -e "\n\n [+] (Building | Fetching) $BIN :: $SOURCE_URL\n"
      #Build 
       ...
       GOOS="linux" GOARCH="amd64" CGO_ENABLED="0" go build -v -ldflags="-buildid= -s -w -extldflags '-static'" "./cmd/asnmap" ; cp "./asnmap" "$BINDIR/asnmap" ; popd >/dev/null 2>&1
