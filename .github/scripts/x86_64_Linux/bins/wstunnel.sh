...
if [ "$SKIP_BUILD" == "NO" ]; then
   #wstunnel : Tunnel all your traffic over websocket protocol - Bypass firewalls/DPI
     export BIN="wstunnel" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/erebe/wstunnel" #github/gitlab/homepage/etc for $BIN
