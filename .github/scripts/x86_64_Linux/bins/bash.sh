    ...
    #bash: GNU Bourne-Again Shell, the de facto standard shell on Linux
     ...
     #-------------------------------------------------------#    
      ...
      ##Meta
       ...
       rclone lsjson --fast-list "r2:/bin/x86_64_Linux/Baseutils/bash/"  --exclude="BLAKE3SUM" --exclude="*.7z" --exclude="*.json" --exclude="*.log" --exclude="*.md" --exclude="SHA256SUM" --exclude="*.txt" | \
