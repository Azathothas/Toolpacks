...
if [ "${SKIP_BUILD}" == "NO" ]; then
    #notify-send: Rust version of notify-send for display notifications on linux desktop
     export BIN="notify-send"
     export SOURCE_URL="https://github.com/VHSgunzo/notify-send-rs"
      ...
      #Build
       ...
       docker run --privileged --net="host" --name "alpine-builder" --pull="always" "azathothas/alpine-builder:latest" \
        ...
        #Build
         ...
         cp "/build-bins/notify-send-rs" "/build-bins/notify-send"
