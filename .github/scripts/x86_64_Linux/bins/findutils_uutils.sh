...
if [ "$SKIP_BUILD" == "NO" ]; then
     ...
     export BIN="find-rs" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/uutils/findutils" #github/gitlab/homepage/etc for $BIN
     echo -e "\n\n [+] (Building | Fetching) $BIN :: $SOURCE_URL\n"
      #Build 
       ...
       cp "./target/$RUST_TARGET/release/find" "$BINDIR/find-rs"
       cp "./target/$RUST_TARGET/release/xargs" "$BINDIR/xargs-rs"
fi
#-------------------------------------------------------#
