...
if [ "$SKIP_BUILD" == "NO" ]; then
    #unifetch : An unofficial inheritor of Neofetch
     export BIN="unifetch" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/nmimusic/unifetch" #github/gitlab/homepage/etc for $BIN
     echo -e "\n\n [+] (Building | Fetching) $BIN :: $SOURCE_URL\n"
      #Fetch  
       eval "$EGET_TIMEOUT" eget "https://raw.githubusercontent.com/nmimusic/unifetch/master/unifetch" --to "$BINDIR/unifetch"
fi
#-------------------------------------------------------#
