    ...
    #pax-utils : ELF utils that can check files for security relevant properties
     ...
     #-------------------------------------------------------#
      ...
      ##Meta
       ...
       rclone lsjson --fast-list "r2:/bin/x86_64_Linux/Baseutils/pax-utils/" --exclude="*.7z" --exclude="*.AppImage" --exclude="*.gz" --exclude="*.jq" --exclude="*.json" --exclude="*.log" --exclude="*.md" --exclude="*.tar" --exclude="*.tgz" --exclude="*.tmp" --exclude="*.txt" --exclude="*.upx" --exclude="*.zip" | \
