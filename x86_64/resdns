...
if ! command -v dnsx >/dev/null 2>&1; then
   curl -qfsSL "https://bin.ajam.dev/x86_64_Linux/dnsx" -o "$tmp_bin/dnsx"
   chmod +xwr "$tmp_bin/dnsx"
fi
#massdns
if ! command -v massdns >/dev/null 2>&1; then
   curl -qfsSL "https://bin.ajam.dev/x86_64_Linux/massdns" -o "$tmp_bin/massdns"
...
if ! command -v puredns >/dev/null 2>&1; then
   curl -qfsSL "https://bin.ajam.dev/x86_64_Linux/puredns" -o "$tmp_bin/puredns"
   chmod +xwr "$tmp_bin/puredns"
fi
#shuffledns
if ! command -v shuffledns >/dev/null 2>&1; then
   curl -qfsSL "https://bin.ajam.dev/x86_64_Linux/shuffledns" -o "$tmp_bin/shuffledns"
...
if ! command -v subxtract >/dev/null 2>&1; then
   curl -qfsSL "https://bin.ajam.dev/x86_64_Linux/subxtract" -o "$tmp_bin/subxtract"
